...
densityShape = "gauss";                 % gauss, ... (others could be implemented) 
...
filename = strcat(".",filesep,'cartesian1D_',num2str(targetKspaceSize),'_',num2str(trajectoryLength),'_',num2str(sigma),'.txt');
